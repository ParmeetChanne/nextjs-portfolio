...
const Navbar = () => {
  ...
  return (
    <nav className="flex z-10 items-center rounded-full justify-between w-full max-w-4xl md:p-3 md:px-8 mx-auto my-0 mt-5 bg-white dark:bg-black sticky-nav md:my-8 bg-opacity-60">
