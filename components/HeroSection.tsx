    ...
    return (
        <>
          <div className="px-8 flex flex-col items-start justify-center max-w-2xl mx-auto mt-5 mb-8 md:mb-12">
            <h1
            className="mb-3 md:mb-5 text-3xl font-bold tracking-tight md:text-5xl text-light-white">
            ...
            className="mb-5 text-lg prose text-gray-400">
              A passionate student at York University utilizing technology & finance to craft enduring, sustainable solutions that create a significant impact.
            </h2>
            <div>
