    ...
    <div>
      <a className="w-full" href="https://github.com/ParmeetChanne/Analysing-Economic-Factors-Python">
        ...
        <Image className='mb-4' src="/economic_factors.png" alt="foodsecure" width={300} height={300} />
          ...
          <p className="w-full md:text-center text-left text-gray-600 dark:text-gray-400">A Jupyter notebook created for the analysis of economic factors with python and pandas using the FRED dataset.</p>
        </div>
      </a>
    </div>
    ...
    <div>
      <a className="w-full" href="https://github.com/ParmeetChanne/Stock-Prediction-Streamlit">
        ...
        <Image className='mb-4' src="/streamlit.png" alt="foodsecure" width={300} height={300} />
          ...
          <p className="w-full md:text-center text-left text-gray-600 dark:text-gray-400">This project is a stock prediction webapp created with Python using Meta's Prophet for modeling and Streamlit for Frontend.</p>
        </div>
      </a>
    </div>
    </div>
