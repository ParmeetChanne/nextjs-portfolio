...
const ContactSection = () => {
  return (
    <div className="px-8 flex flex-col items-start justify-center max-w-2xl mx-auto mb-16">
        <h3 className=" text-2xl font-bold tracking-tight md:text-4xl text-light-white">
            Get In Touch
        </h3>
        <a href="https://www.linkedin.com/in/parmeet-singh-channe/">
        <div className="flex flex-row items-center justify-between w-full max-w-2xl p-5 pb-0 mx-auto rounded-lg bg-transparent">
            <Image className='' src="/linkedin.svg" alt="linkedin" width={30} height={30} />
            <h4 className="w-full ml-4 text-sm font-medium  md:text-xl text-gray-100  hover:text-dark-200 ">
        ...
        <div className="flex flex-row items-center justify-between w-full max-w-2xl p-5 pb-0 mx-auto mb-6 rounded-lg bg-transparent">
        ...
        <div className="flex flex-row items-center justify-between w-full max-w-2xl p-5 pt-0 mx-auto rounded-lg bg-transparent">
