...
const ProjectsSection = () => {
  ...
  return (
    <div className="px-8 flex flex-col items-start justify-start max-w-2xl mx-auto mt-5 mb-10">
        <h3 className="mb-8 text-2xl font-bold tracking-tight  md:text-4xl text-light-white">
                  Favourite Projects
          </h3>
    {/*<div>
    ...
    <div>
      <a className="w-full flex flex-col-reverse md:flex-row-reverse items-center justify-center" href="https://github.com/ParmeetChanne/foodsecure">
        <div className="flex flex-col items-start justify-start w-full max-w-2xl mb-4 p-5 md:pr-0 mx-auto rounded-lg bg-transparent">
          ...
          <p className="w-full text-left text-gray-400">This full-stack project utilizes modern technologies like NextJS, Stripe, TypeScript and Vercel to facilitate the sharing of surplus food.</p>
        </div>
    ...
    <div>
      <a className="w-full flex flex-col-reverse md:flex-row-reverse items-center justify-center" href="https://github.com/ParmeetChanne/Analysing-Economic-Factors-Python">
        <div className="flex flex-col items-start justify-start w-full max-w-2xl mb-4 p-5 md:pr-0 mx-auto rounded-lg bg-transparent">
          ...
          <p className="w-full text-left text-gray-400">A Jupyter notebook created for the analysis of economic factors with python and pandas using the FRED dataset.</p>
        </div>
    ...
    <div>
      <a className="w-full flex flex-col-reverse md:flex-row-reverse items-center justify-center" href="https://github.com/ParmeetChanne/credit-fraud-detection/">
        <div className="flex flex-col items-start justify-start w-full max-w-2xl mb-4 p-5 md:pr-0 mx-auto rounded-lg bg-transparent">
          ...
          <p className="w-full text-left text-gray-400">A Jupyter Notebook to demonstrate the building of a machine learning model to detect credit card fraud using logistic regression and evaluation metrics in Python and Scikit-Learn.</p>
        </div>
    ...
    <div className=''>
      <a className="w-full flex flex-col-reverse md:flex-row-reverse items-center justify-center" href="https://github.com/ParmeetChanne/Stock-Prediction-Streamlit">
        <div className="flex flex-col items-start justify-start w-full max-w-2xl p-5 mx-auto rounded-lg bg-transparent">
          <div className="flex flex-col justify-between md:flex-row">
            <h4 className="w-full mb-2 text-lg text-left font-medium  md:text-xl text-gray-100  hover:text-dark-200 ">
              Stock Price Prediction Webapp
            </h4>
          </div>
          <p className="w-full text-left text-gray-400">This project is a stock prediction webapp created with Python using Metas Prophet for modeling and Streamlit for Frontend.</p>
        </div>
        <Image className="mb-4" src="/streamlit.png" alt="streamlit" width={300} height={300} />
      </a>
    </div>
