  ...
  return (
    <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mt-5 mb-16">
        ...
        <div className="flex flex-row items-center justify-between w-full max-w-2xl p-5 pb-0 mx-auto rounded-lg bg-light-white dark:bg-transparent">
            <Image className='' src="/Linkedin_icon.svg" alt="linkedin" width={30} height={30} />
            <h4 className="w-full ml-4 text-base font-medium text-gray-900 md:text-xl dark:text-gray-100 dark:hover:text-dark-200 hover:text-dark-200 ">
